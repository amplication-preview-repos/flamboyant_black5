...
@InputType()
class RegistrationCreateNestedManyWithoutWeddingsInput {
...
export { RegistrationCreateNestedManyWithoutWeddingsInput as RegistrationCreateNestedManyWithoutWeddingsInput };
