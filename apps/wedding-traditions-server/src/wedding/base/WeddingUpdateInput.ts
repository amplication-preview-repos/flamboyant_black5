...
@InputType()
class WeddingUpdateInput {
  @ApiProperty({
    required: false,
    type: () => CulturalPracticeUpdateManyWithoutWeddingsInput,
  })
  @ValidateNested()
  @Type(() => CulturalPracticeUpdateManyWithoutWeddingsInput)
  @IsOptional()
  @Field(() => CulturalPracticeUpdateManyWithoutWeddingsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => RegistrationUpdateManyWithoutWeddingsInput,
  })
  @ValidateNested()
  @Type(() => RegistrationUpdateManyWithoutWeddingsInput)
  @IsOptional()
  @Field(() => RegistrationUpdateManyWithoutWeddingsInput, {
    nullable: true,
  })
...
export { WeddingUpdateInput as WeddingUpdateInput };
